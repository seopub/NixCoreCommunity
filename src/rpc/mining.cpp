...
UniValue parseblock(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            "parseblock ( TemplateRequest )\n"
            "\nAccept block using json input\n"
			"\nArguments:\n"
			"{\n"
			"  \"hash\": \"b15e9f8c61401401943304d3052e129daa6fcec4c5c44d469d3e275bb12d07dc\",\n"
			"  \"confirmations\": 726,\n"
			"  \"strippedsize\": 280,\n"
			"  \"size\": 280,\n"
			"  \"weight\": 1120,\n"
			...
			"  \"version\": 536870912,\n"
			"  \"versionHex\": \"20000000\",\n"
			"  \"merkleroot\": \"65869b121b8bd3e5678f9fcfb4a0d555ddbc4b1eed307fe37abe97e708218cbf\",\n"
			"  \"tx\": [\n"
			"    \"65869b121b8bd3e5678f9fcfb4a0d555ddbc4b1eed307fe37abe97e708218cbf\"\n"
			"  ],\n"
			"  \"time\": 1708963697,\n"
			"  \"mediantime\": 1708963612,\n"
			"  \"nonce\": 50386,\n"
			"  \"bits\": \"1e0fffff\",\n"
			"  \"difficulty\": 0.0002441371325370145,\n"
			"  \"chainwork\": \"000000000000000000000000000000000000000000000000000000003e9003f8\",\n"
			"  \"previousblockhash\": \"4d27ee1eb702d0b16b31c112596f86465f3a59e6177b2ec40fa9d857989ff8ce\",\n"
			"  \"nextblockhash\": \"c26de737de81b6a67ff04a5c323f09514bc0977a664241021f5546b6d93fe48b\"\n"
			"}\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("parseblock", "")
            + HelpExampleRpc("parseblock", "")
         );
    ...
    if (g_connman->GetNodeCount(CConnman::CONNECTIONS_ALL) == 0)
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "NIX is not connected!");
...
UniValue estimatefee(const JSONRPCRequest& request)
{
    ...
    if (!IsDeprecatedRPCEnabled("estimatefee")) {
        throw JSONRPCError(RPC_METHOD_DEPRECATED, "estimatefee is deprecated and will be fully removed in v0.17. "
            "To use estimatefee in v0.16, restart nixd with -deprecatedrpc=estimatefee.\n"
